<?php
/**
 * underscoresass functions and definitions
 *
...
function underscoresass_setup() {
	 ...
	 * If you're building a theme based on underscoresass, use a find and replace
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'underscoresass' ),
	) );
...
function underscoresass_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Sidebar', 'underscoresass' ),
		'id' => 'sidebar-1',
